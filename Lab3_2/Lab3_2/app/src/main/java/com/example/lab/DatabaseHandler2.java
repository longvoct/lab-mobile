...
public class DatabaseHandler2 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_STUDENTS + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_NAME + " TEXT," + KEY_ADDR + " TEXT," + KEY_PH_NO + " TEXT" + ")";
    ...
    public void addStudent(Student student) {
        ...
        inititalValues.put(KEY_ADDR, student.getAddress());
        inititalValues.put(KEY_PH_NO, student.getPhoneNumber());
        db.insert(TABLE_STUDENTS,null, inititalValues);
        db.close();
    }
    ...
    public Student getStudent(int id) {
        ...
        Cursor cursor = db.query(TABLE_STUDENTS, null, KEY_ID + " = ?", new String[] { String.valueOf(id) },null, null, null);
        if(cursor != null)
            cursor.moveToFirst();
    ...
    public void updateStudent(Student student) {
        ...
        values.put(KEY_ADDR, student.getAddress());
